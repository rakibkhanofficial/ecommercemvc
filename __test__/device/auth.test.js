...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Owen_Schneider41',
      password: 'YKTGi2t_g5s09a3',
      email: 'Price.Kuphal20@hotmail.com',
      name: 'Samuel Adams',
      shippingAddress: [
        {
          _id: false,
      ...
      wishlist: [ {
        _id: false,
        productId: 'encompassing' 
      } ],
      userType: 148,
      mobileNo: '(768) 515-2198',
      resetPasswordLink: {},
      loginRetryLimit: 925,
      loginReactiveTime: '2024-03-11T19:46:03.443Z',
      id: '65be44341a6d6f16d27cfc19'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Joany.Schowalter19',
        'password':'RKh5oanyjjWLFUv',
        'email':'Dejon.Jacobs67@gmail.com',
        'name':'Miss Faye Hauck',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Optimized',
          'address1':'Up-sized',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Dejon.Jacobs67@gmail.com', });
