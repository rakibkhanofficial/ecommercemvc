...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Terry_Hane',
      password: 'RL5F3RqLuAuv3U5',
      email: 'Ezequiel_Walker13@yahoo.com',
      name: 'Patti Jacobs',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 43,
      mobileNo: '(850) 026-2392',
      resetPasswordLink: {},
      loginRetryLimit: 946,
      loginReactiveTime: '2024-03-22T20:43:01.457Z',
      id: '65be44351a6d6f16d27cfc85'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Salvador.Stoltenberg11',
        'password':'NvmAlVNrINCtMGn',
        'email':'Wilson_Johnston92@gmail.com',
        'name':'Andrea McGlynn',
        'shippingAddress':[{
          '_id':false,
          'pincode':'logistical',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Wilson_Johnston92@gmail.com', });
