...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Cleve_Von',
      password: 'lPqV5UvvsWcxHmM',
      email: 'Amelie35@gmail.com',
      name: 'Dr. Leticia Feil',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Harbor',
          address1: 'Electronics',
          address2: 'protocol',
          landmark: 'invoice',
          city: 'Ergonomic',
          isDefault: true,
      ...
      userType: 520,
      mobileNo: '(300) 729-7900',
      resetPasswordLink: {},
      loginRetryLimit: 441,
      loginReactiveTime: '2024-06-10T02:46:59.428Z',
      id: '65be44341a6d6f16d27cfbad'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Wyatt_Paucek24',
        'password':'a9XtnOs7yszRHZv',
        'email':'Napoleon_Tillman49@hotmail.com',
        'name':'Benjamin Smith',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Bacon',
          ...
          'isDefault':false,
          'state':'strategy',
          'addressType':'cutting-edge',
          'fullName':'encompassing',
          'mobile':365,
          'addressNo':193
        }],
        'wishlist':[{
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Napoleon_Tillman49@hotmail.com', });
